...
`ffa90f6e9e70` (`/version`, nach #235 S56-A; Production-Domain
...
Retrieval (#235; kein Live-LLM/Flag-Flip) sind in `main` integriert
(`docs/architecture/S56_A_RAG_SCOPE_LOCK.md`).
...
LIVE_BUILD_SHA_OBSERVED=ffa90f6e9e70
