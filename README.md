...
`15f8b9e20e00` (`/version`, nach #191 UX-Honesty-Pack; Production-Domain
`web-production-51d3c8.up.railway.app`); Ready-Check `database=not_configured`.
Freigabe A–D (#187), Docs-Sync (#188/#190), Returning-Hero-CTA (#189) und
UX-Honesty-Pack (#191) sind in `main` integriert. Production-Auth und Railway-DB
bleiben gesperrt.
