...
**Status:** Dokumentarischer Scope-Lock. Keine Schema-, SQL-, Migrations-, Datenbank-, Docker-, Railway-, Runtime- oder Deploymentfreigabe.

**Parent:** GitHub Issue #94  
**Baseline:** `caa1168acbbe3d64d59934c800629853a2cfebb8`  
**Arbeitsbranch:** `docs/s51b-c-schema-migration-scope-lock-20260730`
...
Dieser lokale Dokumentationsstand ist rücknehmbar durch:

1. Entfernen dieser ungetrackten Datei;
2. Wechsel auf den vorherigen Branch;
3. Entfernen des lokalen Dokumentationsbranches.
...
S51B_C_SCOPE_COMMIT_AUTHORIZED=NO
S51B_C_SCOPE_PUSH_AUTHORIZED=NO
S51B_C_SCOPE_PR_AUTHORIZED=NO
