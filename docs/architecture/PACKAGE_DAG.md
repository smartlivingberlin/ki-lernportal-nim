...
| `auth` | Credentials, Sessions, Rollen, Scopes und Ownership | React-Seiten, direkte KI-Aufrufe | S52-A/B Runtime; S52-C/D Web-Grenze dokumentiert (kein Login-UI, keine DB) |
