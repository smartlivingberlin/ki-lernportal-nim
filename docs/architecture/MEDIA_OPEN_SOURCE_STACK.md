...
**M5-A3:** Mock-Tutor-Expansion auf Lektion `l3` — Scope
`MEDIA_M5_A3_MOCK_TUTOR_L3.md`. Integriert über #254 (`677c9f88fb37`).
Weiterhin Preset-Fragen, kein Freitext, keine Live-KI.

**M5-A4:** Mock-Tutor-Expansion auf Lektion `l4` — Scope
`MEDIA_M5_A4_MOCK_TUTOR_L4.md`. Integriert über #256 (`cbc7c435e112`).
Weiterhin Preset-Fragen, kein Freitext, keine Live-KI.
...
`MEDIA_M5_A6_MOCK_TUTOR_L6.md`. Integriert über #262 (`7668d9db2a36`).
Weiterhin Preset-Fragen, kein Freitext, keine Live-KI.

**M5-A7:** Mock-Tutor-Expansion auf Lektion `l7` — Scope
`MEDIA_M5_A7_MOCK_TUTOR_L7.md`. Integriert über #266 (`ee1469595c33`).
Weiterhin Preset-Fragen, kein Freitext, keine Live-KI.

**M5-A8:** Mock-Tutor-Expansion auf Lektion `l8` — Scope
`MEDIA_M5_A8_MOCK_TUTOR_L8.md`. Weiterhin Preset-Fragen, kein Freitext, keine Live-KI.

**M5-A9:** Mock-Tutor-Expansion auf Lektion `l9` — Scope
`MEDIA_M5_A9_MOCK_TUTOR_L9.md`. Weiterhin Preset-Fragen, kein Freitext, keine Live-KI.
...
**S56-C4:** Expansion auf Lektion `l4` — Scope
`S56_C4_CURATED_RETRIEVAL_EXPANSION.md`. Integriert über #253 (`da626afac6e2`).
Korpus + Preset-UI, gleiche Grenzen.

**S56-C5:** Expansion auf Lektion `l5` — Scope
`S56_C5_CURATED_RETRIEVAL_EXPANSION.md`. Integriert über #255 (`fb43b4d948d5`).
Korpus + Preset-UI, gleiche Grenzen.

**S56-C6:** Expansion auf Lektion `l6` — Scope
`S56_C6_CURATED_RETRIEVAL_EXPANSION.md`. Integriert über #258 (`5f51b7f285af`).
Korpus + Preset-UI, gleiche Grenzen.

**S56-C7:** Expansion auf Lektion `l7` — Scope
`S56_C7_CURATED_RETRIEVAL_EXPANSION.md`. Integriert über #261 (`25138d35d04d`).
Korpus + Preset-UI, gleiche Grenzen.
...
**S56-C10:** Expansion auf Lektion `l10` — Scope
`S56_C10_CURATED_RETRIEVAL_EXPANSION.md`. Korpus + Preset-UI, gleiche Grenzen
(kein Flag-Flip, keine Embeddings, keine Live-KI).
