...
**Baseline `main`:** `5baea1e8ff3189de12a4f2c2c3654faa7c01b397` (nach #196 Product-C)
**Status:** Concept-Demo live inkl. Freigabe A–D (#187), Honesty-Pack (#191),
Integrity A1–A4 (#193) und Product-C (#196: Glossar vollständig, Share-URLs,
Self-Check/Unsicher persistiert, Demnächst-Pfade; Performance B1/B2 und
Docs/CI B3/B4 mitgeliefert). Production-Auth/Live-Railway-DB weiter gesperrt.

~~~text
PHASE0_MASTER_BASELINE=PASS_WITH_BLOCKERS
PHASE0A_SOURCE_OF_TRUTH_SYNC=COMPLETE
BACKLOG_NORMALIZATION=COMPLETE
BASELINE_MAIN_SHA=5baea1e8ff3189de12a4f2c2c3654faa7c01b397
LIVE_PRODUCTION_BUILD_SHA=5baea1e8ff31
LIVE_STAGING_BUILD_SHA=5baea1e8ff31
...
DOCS_BASELINE_MAIN_SHA=5baea1e8ff3189de12a4f2c2c3654faa7c01b397
...
STAGING_ENVIRONMENT_CREATED=YES
STAGING_PUBLIC_DOMAIN=ki-lernportal-nim-staging.up.railway.app
LIVE_BUILD_SHA_OBSERVED=5baea1e8ff31
STAGING_BUILD_SHA_OBSERVED=5baea1e8ff31
