...
**Baseline `main`:** `9ab3513b5f1fbde34fee06e7bd44c934b0602ef8` (nach #156 Kernweg-Welten / optionale Vertiefung)
**Status:** Concept-Demo live mit Portal-Welle, Micro-Fortschritt (#153),
Mass-Audience-QA (#154), Kernweg-Sortierung (#155) und Kernweg-Welten /
optionale Vertiefungs-Micro / Mobile-Fokus (#156); S51D-B Staging HTTP-grün;
S52-Login hinter Flag (Default aus); DB-Sessions/Live-Migrate gesperrt

~~~text
PHASE0_MASTER_BASELINE=PASS_WITH_BLOCKERS
PHASE0A_SOURCE_OF_TRUTH_SYNC=COMPLETE
BACKLOG_NORMALIZATION=COMPLETE
BASELINE_MAIN_SHA=9ab3513b5f1fbde34fee06e7bd44c934b0602ef8
LIVE_PRODUCTION_BUILD_SHA=9ab3513b5f1f
LIVE_STAGING_BUILD_SHA=9ab3513b5f1f
...
DOCS_BASELINE_MAIN_SHA=9ab3513b5f1fbde34fee06e7bd44c934b0602ef8
...
STAGING_ENVIRONMENT_CREATED=YES
STAGING_PUBLIC_DOMAIN=ki-lernportal-nim-staging.up.railway.app
LIVE_BUILD_SHA_OBSERVED=9ab3513b5f1f
STAGING_BUILD_SHA_OBSERVED=9ab3513b5f1f
...
(Pilot-Schema, generierte Migration, disposable MySQL-Proof). Eine echte
Live-Datenbankverbindung, produktive Migration oder Seeds bleiben
`DATABASE_CONNECTION_AUTHORIZED=NO` / `S51B_C_SCHEMA_AUTHORIZED=NO`.
