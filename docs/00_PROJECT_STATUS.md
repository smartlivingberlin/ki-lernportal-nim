...
**Baseline `main`:** `30ff92ba00404e078d3a88318cecc4a32c7ce47c` (nach #163 mysql2 3.23.2 Pin)
**Status:** Concept-Demo live mit Später-Welten (#158), S52-D2b Staging-Auth
(#159), Vertiefungs-CTA nur Kernweg (#161), Docs-Sync (#162) und mysql2-Pin
(#163); Production-Auth aus; DB-Sessions/Live-Migrate gesperrt

~~~text
PHASE0_MASTER_BASELINE=PASS_WITH_BLOCKERS
PHASE0A_SOURCE_OF_TRUTH_SYNC=COMPLETE
BACKLOG_NORMALIZATION=COMPLETE
BASELINE_MAIN_SHA=30ff92ba00404e078d3a88318cecc4a32c7ce47c
LIVE_PRODUCTION_BUILD_SHA=30ff92ba0040
LIVE_STAGING_BUILD_SHA=30ff92ba0040
...
DOCS_BASELINE_MAIN_SHA=30ff92ba00404e078d3a88318cecc4a32c7ce47c
...
STAGING_ENVIRONMENT_CREATED=YES
STAGING_PUBLIC_DOMAIN=ki-lernportal-nim-staging.up.railway.app
LIVE_BUILD_SHA_OBSERVED=30ff92ba0040
STAGING_BUILD_SHA_OBSERVED=30ff92ba0040
