...
**Baseline `main`:** `06e65b2e32eb1bc51faba615fe1944ba62abdfbc`
**Status:** S51D-B Staging HTTP-grün; S52-C Auth-Web Scope-Lock; UX-Labels (Einfache Ansicht) integriert (#135); Login-UI/DB-Sessions/Live-Migrate gesperrt

~~~text
PHASE0_MASTER_BASELINE=PASS_WITH_BLOCKERS
PHASE0A_SOURCE_OF_TRUTH_SYNC=COMPLETE
BACKLOG_NORMALIZATION=COMPLETE
BASELINE_MAIN_SHA=06e65b2e32eb1bc51faba615fe1944ba62abdfbc
PR68_MERGED=YES
...
DOCS_BASELINE_MAIN_SHA=06e65b2e32eb1bc51faba615fe1944ba62abdfbc
...
STAGING_ENVIRONMENT_CREATED=YES
STAGING_PUBLIC_DOMAIN=ki-lernportal-nim-staging.up.railway.app
LIVE_BUILD_SHA_OBSERVED=06e65b2e32eb
~~~
