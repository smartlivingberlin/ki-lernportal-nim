...
**Baseline `main`:** `cb6883670fe952f969d3c58f0a1578c71242a85e` (nach #181 Backup-Hash-Fokus)
**Status:** Concept-Demo live mit Fortschritts-Backup (#165/#174/#181), Pfad-Brücken (#166/#179),
Mobile-Hero/Smoke/Content-QA (#169), Docs-Sync (#180), S52-D2b Staging-Auth (#159);
Production-Auth aus; DB-Sessions/Live-Migrate gesperrt

~~~text
PHASE0_MASTER_BASELINE=PASS_WITH_BLOCKERS
PHASE0A_SOURCE_OF_TRUTH_SYNC=COMPLETE
BACKLOG_NORMALIZATION=COMPLETE
BASELINE_MAIN_SHA=cb6883670fe952f969d3c58f0a1578c71242a85e
LIVE_PRODUCTION_BUILD_SHA=cb6883670fe9
LIVE_STAGING_BUILD_SHA=cb6883670fe9
...
DOCS_BASELINE_MAIN_SHA=cb6883670fe952f969d3c58f0a1578c71242a85e
...
STAGING_ENVIRONMENT_CREATED=YES
STAGING_PUBLIC_DOMAIN=ki-lernportal-nim-staging.up.railway.app
LIVE_BUILD_SHA_OBSERVED=cb6883670fe9
STAGING_BUILD_SHA_OBSERVED=cb6883670fe9
...
(Pilot-Schema, generierte Migration, disposable MySQL-Proof). Freigabe C
(2026-08-13) erlaubt zusätzlich den lokalen Migrate-Helper gegen
`ki_nim_s51bc_*` auf localhost (`pnpm migrate:s51b-c-local`). Railway- und
Produktionsdatenbanken sowie Live-Migrate bleiben verboten
(`RAILWAY_DATABASE_PROHIBITED=YES`, `LIVE_MIGRATE_RAILWAY=NO`).
