...
**Baseline `main`:** `fad6cc935f87bceed73218a8a5f5ddb3b875859f` (nach #158 Später-Welten; Auth-D2b-Nachweis in diesem PR)
**Status:** Concept-Demo live mit Portal-Welle bis Später-Welten (#158);
S52-D2b Staging-`AUTH_RUNTIME` HTTP-verifiziert; Production-Auth weiter aus;
S51D-B Staging HTTP-grün; DB-Sessions/Live-Migrate gesperrt

~~~text
PHASE0_MASTER_BASELINE=PASS_WITH_BLOCKERS
PHASE0A_SOURCE_OF_TRUTH_SYNC=COMPLETE
BACKLOG_NORMALIZATION=COMPLETE
BASELINE_MAIN_SHA=fad6cc935f87bceed73218a8a5f5ddb3b875859f
LIVE_PRODUCTION_BUILD_SHA=fad6cc935f87
LIVE_STAGING_BUILD_SHA=fad6cc935f87
...
DOCS_BASELINE_MAIN_SHA=fad6cc935f87bceed73218a8a5f5ddb3b875859f
...
STAGING_ENVIRONMENT_CREATED=YES
STAGING_PUBLIC_DOMAIN=ki-lernportal-nim-staging.up.railway.app
LIVE_BUILD_SHA_OBSERVED=fad6cc935f87
STAGING_BUILD_SHA_OBSERVED=fad6cc935f87
